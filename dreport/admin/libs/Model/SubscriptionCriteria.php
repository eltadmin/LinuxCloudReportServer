...
require_once("DAO/SubscriptionCriteriaDAO.php");

/**
 * The SubscriptionCriteria class extends SubscriptionDAOCriteria and is used
 ...
 * @version 1.0
 */
class SubscriptionCriteria extends SubscriptionCriteriaDAO
{

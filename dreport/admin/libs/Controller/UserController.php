...
class UserController extends AppBaseController
{
	...
	protected function Init()
	{
        ...
        $this->RequirePermission(User::$PERMISSION_ADMIN,
                ...
                'Admin permission is required to configure users');        
	}
	...
	public function Create()
	{
		try
		{
			...
			else
			{
				$user->Save();
				$this->RenderJSON($user, $this->JSONPCallback(), true, $this->SimpleObjectParams());
			    $this->saveLog('105','User add username:'.$user->Username);
            }
	...
	public function Update()
	{
		try
		{
			...
			else
			{
				$user->Save();
				$this->RenderJSON($user, $this->JSONPCallback(), true, $this->SimpleObjectParams());
                $this->saveLog('106','User update id:'.$pk);
			}
	...
	public function Delete()
	{
		try
		{
			...
			$this->RenderJSON($output, $this->JSONPCallback());
            $this->saveLog('107','User delete id:'.$pk);

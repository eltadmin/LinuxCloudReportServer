...
-->
		...
		<% items.each(function(item) { %>
			<tr id="<%= _.escape(item.get('objectid')) %>">
				...
				<td><%if (item.get('expiredate')) { %><%= _date(app.parseDate(item.get('expiredate'))).format('MMM D, YYYY') %><% } else { %>NULL<% } %></td>
...
-->
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newSubscriptionButton" class="btn btn-primary">Add Subscription</button>
	</p>

...
<?php
    ...
    $C_SQL_SUB .= 'where (cast(S.SPLU_DATETIME - cast(TIMEOFFSET as float)/24 as date) = PARAMDATE) and (S.SPLU_REVOKED_ = 0) ';
...
*/
       ...
       if ($_SESSION['lang'] == 'bg'){
         echo '&nbsp;•&nbsp;<a href="groupturnover.php?lang=en"><img src="images/en.png" /></a>';
       } else {
         echo '&nbsp;•&nbsp;<a href="groupturnover.php?lang=bg"><img src="images/bg.png" /></a>';
       }
    ...
    <h1 align="center"><?php echo $lang["rptGroupTurnoverTitle"]; ?></h1>
    <?php
  ...
  <script>
   ...
   <?php
    if ($expiredate >= time()){
        ...
        echo 'window.location.href = "groupturnover.php?id=';
		echo $objectid;

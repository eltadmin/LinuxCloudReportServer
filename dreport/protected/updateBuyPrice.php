...
$C_SQL = '{"Id":"DatabaseId","Pass":"1234","PLUESQuery":{"Type":"Query","SQL":"UPDATE PLUES SET PLU_BUY_PRICE = \'' . $buyPrice . '\' WHERE PLU_NUMB = \'' . $pluNumb . '\'"}}';
...
$pDatabase->logevent(OPER_COMMAND,$objectid,'report: UpdateEcrName.php New sell price for plu= '.$pluNumb.' objectid='.$objectid);


if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['pluNumb'], $_POST['buyPrice'])) {
    $pluNumb = $_POST['pluNumb'];
    $buyPrice = $_POST['buyPrice'];
    ...
    if ($result === FALSE) {
        ...
        // Optionally, handle and display the result/response from your service
    }
} else {

  ...
  <div class="login-card">
    <div class="login-help">
      <?php
       ...
       if ($_SESSION['lang'] == 'bg'){
         echo '&nbsp;•&nbsp;<a href="monthlyStockExpenses.php?lang=en"><img src="images/en.png" /></a>';
       } else {
         echo '&nbsp;•&nbsp;<a href="monthlyStockExpenses.php?lang=bg"><img src="images/bg.png" /></a>';
       }
    ...
    <h1 align="center">
	<?php 
		echo $lang["rptMonthlyStockExpenses"]; 

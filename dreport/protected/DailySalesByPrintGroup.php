...
if ($rptdata->ResultCode == 0 && !empty($rptdata->DailySalesByPrintGroup)) {
    $chartBars = count($rptdata->DailySalesByPrintGroup);
    foreach ($rptdata->DailySalesByPrintGroup as $item) {
...
<div class="login-card">
    <div class="login-help">
        ...
        if ($_SESSION['lang'] == 'bg') {
            echo '&nbsp;•&nbsp;<a href="dailysalesbyprintgroup.php?lang=en"><img src="images/en.png" /></a>';
        } else {
            echo '&nbsp;•&nbsp;<a href="dailysalesbyprintgroup.php?lang=bg"><img src="images/bg.png" /></a>';
        }
    ...
    <h1 align="center"><?php echo $lang["rptGroupPrint"]; ?></h1>
    <h4 align="center">
        <?php
